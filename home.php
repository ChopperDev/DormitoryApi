...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (
        isset(
            $_POST['room_number'], 
            $_POST['previous_electricity_unit'], 
            $_POST['current_electricity_unit'],
            $_POST['electricity_fee'], 
            $_POST['water_fee'], 
            $_POST['wifi_fee'], 
            $_POST['common_fee'], 
            $_POST['total_amount']
        ...
        $stmt = $conn->prepare(
            "INSERT INTO rooms (room_number, previous_electricity_unit, current_electricity_unit, electricity_fee, water_fee, wifi_fee, common_fee, total_amount)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
        );
        $stmt->bind_param(
            'ssssssss', 
